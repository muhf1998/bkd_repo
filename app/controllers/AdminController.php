...
class AdminController extends Controller
{
  ...
  {
    $data['page'] = 'Form Kegiatan Dosen';
    $data['jenis_kegiatan'] = $this->model('Jenis_Kegiatan_Model')->getData();
    $data['rekomendasi'] = ['Lanjutkan', 'Selesai', 'Gagal', 'Beban lebih', 'Lainnya'];

    $dosen = ($_SESSION['user']['role'] = 'Admin') ? $data['dosen'] = $this->model('Users_Model')->getByRole('Dosen') : $data['dosen'] = $this->model('Users_Model')->getUsersWhereId($_SESSION['user']['id']);
  ...
  public function detail_kegiatan_dosen($id)
  {
    ...
    $data['title'] = 'Detail Kegiatan Dosen';
  ...
  {
    $data['page'] = 'Rekap Laporan Kegiatan';
    $data['kegiatan_dosen'] = $this->model('Kegiatan_Dosen_Model')->getAll();
