      ...
      <div class="card-body">
        ...
        <form action="<?= BASEURL ?>AdminController/create_kegiatan_dosen" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group mt-2">
            ...
            <input type="text" name="nip" id="nip" class="form-control w-75" required placeholder="Masukan nomor NIP/NIDN">
          </div>
          ...
          <div class="form-group mt-2">
            ...
            <input type="number" name="sks" id="sks" class="form-control w-25" required placeholder="Masukkan nomor SKS...">
          </div>
          ...
          <div class="form-group mt-2">
            <label for="title">SKS</label>
            <input type="number" name="sks_2" id="sks_2" class="form-control w-25" required placeholder="Masukkan nomor SKS...">
          </div>

          <div class="form-group mt-2">
            <label for="title">Rekomendasi</label>
            <!-- <input type="text" name="rekomendasi" id="rekomendasi" class="form-control" required placeholder="Masukkan rekomendasi..."> -->
            <select name="rekomendasi" id="rekomendasi" class="form-control">
              <option value="">-- Pilih Rekomendasi --</option>
              <?php foreach ($data['rekomendasi'] as $r) : ?>
