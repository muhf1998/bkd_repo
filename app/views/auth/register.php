      ...
      <div class="card-body">
        <form action="<?= BASEURL; ?>AuthController/register_proses/<?= $data['role'] ?>" method="post" enctype="multipart/form-data">
          <div class="form-group mt-2">
            ...
            <input type="text" name="nama" id="nama" class="form-control" value="<?= isset($data['data_old']['nama']) ? $data['data_old']['nama'] : '' ?>" required placeholder="Masukkan nama anda....">
          </div>

          <div class="form-group mt-2">
            <label for="title">Gelar Depan</label>
            <input type="text" name="gelar_depan" id="gelar_depan" class="form-control" value="<?= isset($data['data_old']['gelar_depan']) ? $data['data_old']['gelar_depan'] : '' ?>" required placeholder="Masukkan gelar depan anda...">
          </div>

          <div class="form-group mt-2">
            <label for="title">Gelar Belakang</label>
            <input type="text" name="gelar_belakang" id="gelar_belakang" class="form-control" value="<?= isset($data['data_old']['gelar_belakang']) ? $data['data_old']['gelar_belakang'] : '' ?>" required placeholder="Masukkan gelar belakang anda...">
          </div>

          <div class="form-group mt-2">
            <label for="title">Alamat PT</label>
            <input type="text" name="alamat_pt" id="alamat_pt" class="form-control" value="<?= isset($data['data_old']['alamat_pt']) ? $data['data_old']['alamat_pt'] : '' ?>" required placeholder="Masukkan alamat PT anda...">
          </div>
          ...
          <div class="form-group mt-2">
            ...
            <select name="jabatan_fungsional" id="jabatan_fungsional" class="form-control">
              ...
              <?php foreach ($data['jabatan_fungsional'] as $jf) : ?>
          ...
          <div class="form-group mt-2">
            ...
            <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" value="<?= isset($data['data_old']['tempat_lahir']) ? $data['data_old']['tempat_lahir'] : '' ?>" required placeholder="...">
          </div>
          <div class="form-group mt-2">
            <label for="title">Tanggal Lahir</label>
            <input type="text" name="tgl_lahir" id="tgl_lahir" class="form-control" value="<?= isset($data['data_old']['tgl_lahir']) ? $data['data_old']['tgl_lahir'] : '' ?>" required placeholder="...">
          </div>
